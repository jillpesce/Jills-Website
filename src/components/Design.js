            ...
            <div className="section" data-anchor="Design">
                <div class="slide" data-anchor="sound">
                    <Card class="card" text={this.props.dark === 'dark' ? 'white' : 'dark'}
                        ...
                        <Card.Img variant="top" src="./img/artboard.jpg" class="card-img" style={{ height: '24rem' }} />
                        <Card.Body>
                            <Card.Title style={{ fontSize: '2rem' }}>Sound Abstraction</Card.Title>
                            <Card.Text style={{ fontSize: '1.5rem' }}>
                                Visual abstraction of a field recording taken during a concert.
                            </Card.Text>
                        </Card.Body>
                    </Card></div>
                <div class="slide" data-anchor="city">
                    <Card class="card" text={this.props.dark === 'dark' ? 'white' : 'dark'}
                        bg={this.props.dark === 'dark' ? 'dark' : 'white'}>
                        <Card.Img variant="top" src="./img/city.jpg" class="card-img" style={{ height: '24rem' }} />
                        <Card.Body>
                            <Card.Title style={{ fontSize: '2rem' }}>City Abstraction</Card.Title>
                            <Card.Text style={{ fontSize: '1.5rem' }}>
                                Visual abstraction of a trading city from Italo Calvino’s book, <em>Invisible Cities</em>.
                            </Card.Text>
                        </Card.Body>
                    </Card></div>
                ...
                <div class="slide" data-anchor="animation">
                    <Card class="card" text={this.props.dark === 'dark' ? 'white' : 'dark'}
                        bg={this.props.dark === 'dark' ? 'dark' : 'white'}>
                        <Card.Img variant="top" src="./img/birds.png" class="card-img" />
                        <Card.Body>
                            <Card.Title style={{ fontSize: '2rem' }}>Poem Abstraction</Card.Title>
                            <Card.Text style={{ fontSize: '1.5rem' }}>
                                Animated abstraction of W. B. Yeats' poem <em>Aedh Wished for the Clothes of Heaven</em>.
                            </Card.Text>
                ...
                <div class="slide" data-anchor="landmarks">
                    <Card class="card" text={this.props.dark === 'dark' ? 'white' : 'dark'}
                        bg={this.props.dark === 'dark' ? 'dark' : 'white'}>
                        <Card.Img variant="top" src="./img/landmarks.png" class="card-img" />
                        <Card.Body>
